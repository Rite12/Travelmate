...
class MapList : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        direction.setOnClickListener {
            val gmmIntentUri = Uri.parse("geo:-6.598615,106.799317(Kebun Raya Bogor)")
        ...
        direction2.setOnClickListener {
            val gmmIntentUri = Uri.parse("geo:-6.700333,106.985690(Puncak)")
            val mapIntent = Intent(Intent.ACTION_VIEW, gmmIntentUri)
            mapIntent.setPackage("com.google.android.apps.maps")
            startActivity(mapIntent)
        }
        ...
        direction3.setOnClickListener {
            val gmmIntentUri = Uri.parse("geo:-6.714824,106.951085(Taman Safari)")
            val mapIntent = Intent(Intent.ACTION_VIEW, gmmIntentUri)
            mapIntent.setPackage("com.google.android.apps.maps")
            startActivity(mapIntent)
        }
